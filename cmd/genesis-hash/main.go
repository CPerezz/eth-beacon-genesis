...
// no PBT field at all, so asking the parsed config would not compile there — and this
// probe has to build both ways for its own negative control to mean anything.
func wantsPBT(path string) bool {
